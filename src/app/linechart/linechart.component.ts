...
const d3Linechart=require('d3-line-chart');
...
export class LinechartComponent implements OnInit {
  datad = fetch("https://api.weather.gov/gridpoints/OKX/33,37/forecast").then((response) => response.json());
  chart = d3Linechart.LineChart(this.datad, {
    x: (d: { date: any; }) => d.date,
    y: (d: { unemployment: any; }) => d.unemployment,
    z: (d: { division: any; }) => d.division,
    yLabel: "↑ Unemployment (%)",
    width:500,
    height: 500,
    color: "steelblue",
